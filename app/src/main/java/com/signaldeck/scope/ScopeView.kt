...
class ScopeView @JvmOverloads constructor(
    ...
    private val gridPaint = Paint().apply {
        color = Color.argb(25, 77, 255, 160)
        strokeWidth = 1f
    }

    private val midlinePaint = Paint().apply {
        color = Color.argb(55, 77, 255, 160)
        strokeWidth = 1f
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawText(fidelityLabel, 20f, 34f, labelPaint)
    ...
    /**
     * Switch back to reconstructed live mode.
     */
